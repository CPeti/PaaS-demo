    ...
    return (
        <div class="min-h-screen bg-slate-950 flex items-center justify-center px-4">
            ...
            <div class="pointer-events-none fixed inset-0 flex items-center justify-center">
                <div class="h-[600px] w-[600px] rounded-full bg-violet-700/10 blur-3xl" />
            </div>

            <div class="relative w-full max-w-md">
                {/* Logo */}
                <a href="/" class="mb-10 flex items-center justify-center gap-2.5 group">
                ...
                <div class="rounded-2xl border border-slate-800 bg-slate-900/80 backdrop-blur-sm p-8 shadow-2xl shadow-black/40">
                    <div class="mb-8">
                        ...
                        <p class="mt-1 text-sm text-slate-400">Sign in to your album</p>
                    </div>

                    <form id="login-form" onSubmit={handleSubmit} class="space-y-5">
                        <div>
                            <label for="login-username" class="mb-1.5 block text-sm font-medium text-slate-300">
                                Username
                            </label>
                            <input
                                id="login-username"
                        ...
                        <div>
                            <div class="mb-1.5 flex items-center justify-between">
                                <label for="login-password" class="text-sm font-medium text-slate-300">
                                    Password
                                </label>
                            </div>
                            <input
                ...
                <p class="mt-6 text-center text-sm text-slate-500">
                    ...
                    <a href="/register" class="font-medium text-violet-400 hover:text-violet-300 transition-colors">
                        Create one
                    </a>
                </p>
            </div>
